...
from ai_theano import DQN # AI using theano, Double DQN with Prioritized Experience Replay
...
class Game(Widget):
	...
	def update(self, dt):
		...
		brain.update(last_signal, last_action, last_reward, next_signal, target_network, TARGET_UPDATE_PERIOD)
