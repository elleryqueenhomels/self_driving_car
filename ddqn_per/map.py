...
agent = Agent(input_sz=5, output_sz=3, hidden_layer_sizes=[100]) # 5 inputs (dimensionality), 3 outputs (actions)
TEMPERATURE = 50
...
class Game(Widget):
    ...
    def update(self, dt):
        ...
        global agent # specify the global variables (the agent of the car, that is our AI)
        ...
        last_action = agent.select_action(last_signal, TEMPERATURE)
        ...
        # # update the agent (let AI learn)
        agent.train(last_signal, last_action, last_reward, next_signal)
